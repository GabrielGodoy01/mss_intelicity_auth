...
class Test_ListUsersInGroupUsecase:
    ...
    def test_list_users_in_group_usecase(self):
        ...
        users_response = usecase(group=GROUPS.GAIA, access_token="valid_access_token-teste@gmail.com")
    ...
    def test_list_users_in_group_usecase_with_invalid_token(self):
        ...
        with pytest.raises(NoItemsFound):
            usecase(group=GROUPS.GAIA, access_token="valid_access_token-teste3232@gmail.com")
    ...
    def test_list_users_in_group_usecase_with_user_not_admin(self):
        ...
        with pytest.raises(ForbiddenAction):
            usecase(group=GROUPS.GAIA, access_token="valid_access_token-teste3@gmail.com")
    ...
    def test_list_users_in_group_usecase_with_user_not_in_group(self):
        ...
        with pytest.raises(ForbiddenAction):
            usecase(group=GROUPS.GAIA, access_token="valid_access_token-teste2@gmail.com")